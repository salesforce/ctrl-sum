...
class SequenceGenerator(nn.Module):
    def __init__(
        ...
        self.exclude_prefix_max_len = exclude_prefix_max_len
    ...
    def _generate(
        ...
        # restrict the max_len after prefix instead of including prefix:
        if hasattr(self, 'exclude_prefix_max_len') and self.exclude_prefix_max_len is not None and prefix_tokens is not None:
            max_len = min(prefix_tokens.ne(self.pad).sum(1).max().item() + self.exclude_prefix_max_len, max_len)
